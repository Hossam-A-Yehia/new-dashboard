...
// Note that the validation lib Yup is been changed to an arrow function and the name is changed to getValidationSchema to enable exporting to the main component
