...
import ProductsGlobalFilter from './ProductsFilter';
...
describe('ProductsGlobalFilter', () => {
  ...
  const renderComponent = (props = {}) => {
    return render(
      <BrowserRouter>
        <ProductsGlobalFilter {...defaultProps} {...props} />
      </BrowserRouter>
    );
  };
  ...
  it('clears filters when reset button is clicked', () => {
    renderComponent({
      filters: { title: 'test', productGroup: 'group1' },
      value: 'test',
    });
